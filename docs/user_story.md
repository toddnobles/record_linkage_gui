...
- Vicki is an undergraduate student hired to work on a research project and feeling in over her head. She was hired to double check the accuracy of names, DOB, and date of death from digitized documents by comparing the original. She wants to be able to mark cases where she is unsure or unclear if the digitized version is correct so that other more seasoned graduate students can weigh in. She’s worried if she makes a mistake that she’ll cost the professor their entire research grant (that’s not how this works, but she’s new to grants and is stressed). 

- Esther builds and/or fixes the OCR machines used to digitize historical forms. It’s a niche job, but she makes a lot of money and so has a reputation to uphold. She wants to be able to see the most common mistakes in the digitized version of the forms (5 vs S; 1 vs I) so that she can improve the machine and charge even more money. 

- Mark is a PI of a major grant using digitized documents. He recently hired a few undergraduates to assist on this project, including Vicki, and can feel how stressed they are by the research process. He wants a way to flag records that have a high probability of being digitized incorrectly (damaged image, really bad handwriting) so he can warn Vicki and the other undergraduates these might be more difficult to verify (and hopefully make them less stressed). 

- Drew is a genealogy website creator who has digitized many historical records for genealogy purposes. As part of his business model, he is crowdsourcing the verification process of checking that the digitized versions match the picture of documents because he thinks some people have a lot of time on their hands. He wants to be able to see which records have been verified and by how many people. 
