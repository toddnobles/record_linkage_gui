...
- Interaction sidebar
    ...
    - Prev/Next buttons to move to the next image/row of the CSV
    - Search bar for searching for specific row of data (need to decide if this is based on row number or if user can search by other fields)
- Data Display 
